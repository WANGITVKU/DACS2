...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <form id="form1" method="POST"  action="../admin/add_sp.php" class="row" enctype="multipart/form-data">
              ...
              <div class="form-group col-md-3">
                ...
                <label for="exampleSelect" class="control-label">Nhà cung cấp</label>
                <select class="form-control" id="exampleSelect" name="id_dmsp">
                  <option>-- Chọn nhà cung cấp --</option>
                  <?php
                    $conn = mysqli_connect("localhost:3307", "root", "", "banhang");
                    $sql3 = "SELECT * from dm_sp";
                    $kq3 = mysqli_query($conn, $sql3);
                    while ($row3 = mysqli_fetch_array($kq3)) {
                        echo '<option value="' . $row3['id_dmsp'] . '">' . $row3['tendmsp'] . '</option>';
      ...
      <!---------------------------------- ADD DM ------------------------------------------>
  <form id="form2" method="POST" action="../admin/add_dmsp.php"  enctype="multipart/form-data">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <BR>
                ...
                <select class="form-control" id="exampleSelect1" name="id_brand">
                  <option>-- Chọn nhà cung cấp --</option>
                  <?php
                $conn = mysqli_connect("localhost:3307", "root", "", "banhang");
  ...
  <form id="form3" method="POST" action="../admin/add_dm.php">
            ...
            <div class="modal-content">
              <div class="modal-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-12">
                    <label class="control-label">Nhập danh mục mới </label>
                    <input class="form-control" type="text" name="dm" required>
                  </div>
                  <div class="form-group col-md-12">
                    <label class="control-label">Nhập size cho danh mục </label>
              ...
              <?php
                $conn = mysqli_connect("localhost:3307", "root", "", "banhang");
                $sql4 = "SELECT * from danhmuc";
                $kq4 = mysqli_query($conn, $sql4);
                while ($row4 = mysqli_fetch_array($kq4)) {         
                ?>
                <li><?php echo $row4['tendanhmuc'] ?>    </li>
                 <?php }?>     
              </ul>
            </div>
                </div>  
                <BR>               
                <input class="btn btn-save" type="submit"  name="form3_submit" value=" Thêm">
                <a class="btn btn-cancel" data-dismiss="modal" href="#">Hủy bỏ</a>
                <BR>
             </div>
              <div class="modal-footer">
       ...
       <!---------------------END--------------------->
  <!---------------------------------- ADD tình trạng ------------------------------------------>
  <form id="form4" method="POST" action="../admin/add_brand.php">

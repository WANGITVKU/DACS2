           ...
           $password = $_POST["password"];
            ...
            if ($user) {
                if (password_verify($password, $user["password"])) {
                    ...
                    header("Refresh: 2; url=index2.php"); // Chuyển hướng sau 2 giây
        ...
        <div class="form-content">
          ...
          <form action="#" method="post">
            <div class="input-boxes">
              ...
              <div class="text sign-up-text">Don't have an account? <label for="flip" ><a href= "signup.php" > Sign Up </a></label></div>
            </div>
        </form>
      </div>
